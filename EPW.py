...
# Import CSV
anta = ImportFile('MDG_Antananarivo.670830_IWEC.epw')
inchon = ImportFile('KOR_Inchon.471120_IWEC.epw')

# Convert to Daily Data
anta_daily = HourlyToDaily(anta,'Dry Bulb Temperature (F)','Date')
inchon_daily = HourlyToDaily(inchon,'Dry Bulb Temperature (F)','Date')

# Compare
CompareWeather(anta_daily,inchon_daily,'Max Dry Bulb Temperature (F)','Date')
